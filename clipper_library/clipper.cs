...
namespace ClipperLib
{
  ...
  using cInt = Single;
#endif
    //tricking it into thinking IntPoint is Vector2
    using IntPoint = Motio.Geometry.Vector2;

    using Path = List<Motio.Geometry.Vector2>;
  using Paths = List<List<Motio.Geometry.Vector2>>;
  ...
  */
  ...
  public class Clipper : ClipperBase
  {
      ...
      internal void SwapPoints(ref IntPoint pt1, ref IntPoint pt2)
      {
            ...
            IntPoint tmp = new IntPoint(pt1.X, pt1.Y);
            pt1 = pt2;
          pt2 = tmp;
      }
      //------------------------------------------------------------------------------
          ...
          else
          {
            ...
            if (StrictlySimple)
            {
              ...
              if ((e.OutIdx >= 0) && (e.WindDelta != 0) && ePrev != null &&
                ...
                (ePrev.WindDelta != 0))
              {
                IntPoint ip = new IntPoint(e.Curr.X, e.Curr.Y);
#if use_xyz
                SetZ(ref ip, ePrev, e);
#endif
