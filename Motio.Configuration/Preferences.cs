...
namespace Motio.Configuration
{
    ...
    {
        public const string ShowWarning_NoPropertyForTL = "ShowWarning_NoPropertyForTL";
        public const string ShowWarning_ExpressionError = "ShowWarning_ExpressionError";
        public const string IgnoreVersion = "IgnoreVersion";
        public const string TestChannelPass = "TestChannelPass";
        ...
        {
            { ShowWarning_NoPropertyForTL, new PreferenceEntry(true) },
            { ShowWarning_ExpressionError, new PreferenceEntry(true) },
            { IgnoreVersion, new PreferenceEntry("1/1/2000/0") },
            { TestChannelPass, new PreferenceEntry("null") }
        };
        ...
        public void _SetValue(PreferenceEntry entry, object value)
        {
            ...
            if (confirmation)
                ...
                throw new ConfirmationException("Configs:" + entry.shortName
