...
namespace Motio.Geometry
{
    ...
    public struct Matrix : IEquatable<Matrix>
    {
        ...
        {
            //throw new NotImplementedException("you didn't test that");
            Multiply(ref this, ref matrix, out this);
        }

        public void Prepend(Matrix matrix)
        {
            //throw new NotImplementedException("you didn't test that");
            Multiply(ref matrix, ref this, out this);
        }
        ...
        /// <summary>
        /// Monogame does some optimisation on his orthographic camera, and assumes the mesh will be on 
        /// a plan of z = 0. this function doesn't do that 
        /// </summary>
        ...
        /// <returns></returns>
        public static Matrix CreateOrthographic2(float left, float right, float top, float bottom, float zNearPlane, float zFarPlane)
        {
            //https://en.wikipedia.org/wiki/Orthographic_projection
            float farMnear = zFarPlane - zNearPlane;
            ...
            Matrix m = new Matrix
            {
                ...
                M12 = 0,
                M13 = 0,
                M14 = -(right+left)/rightMleft,
                M21 = 0,
                M22 = 2f / topMbottom,
                M23 = 0,
                M24 = -(top+bottom)/topMbottom,
                M31 = 0,
                M32 = 0,
                M33 = -2f / farMnear,
                M34 = -(zFarPlane + zNearPlane) / farMnear,
                M41 = 0,
                M42 = 0,
                M43 = 0,
                M44 = 1
