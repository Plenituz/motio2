...
namespace Motio.Geometry
{
    ...
    {
        #region Added By Plenituz
        //public static explicit operator System.Windows.Media.Media3D.Quaternion(Quaternion q)
        //{
        //    return new System.Windows.Media.Media3D.Quaternion(q.X, q.Y, q.Z, q.W);
        //}

        //public static explicit operator Quaternion(System.Windows.Media.Media3D.Quaternion q)
        //{
        ...
        //{
        //    return CreateFromYawPitchRoll((float)yaw, (float)pitch, (float)roll);
        //}
        #endregion
